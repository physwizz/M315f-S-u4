...
static int gpu_dvfs_update_config_data_from_dt(struct kbase_device *kbdev)
{
	...
	platform->gpu_max_clock_limit = (int)cal_dfs_get_max_freq(platform->g3d_cmu_cal_id);
        platform->interactive.highspeed_clock = 1369000;
	...
	if (of_data_int == TMU_LOCK_CLK_END)
		...
		platform->tmu_lock_clk[0]=1369000;
		platform->tmu_lock_clk[1]=1053000;
		platform->tmu_lock_clk[2]=949000;
		platform->tmu_lock_clk[3]=839000;
		platform->tmu_lock_clk[4]=764000;
		platform->tmu_lock_clk[5]=683000;
